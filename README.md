...
メトリクスカタログとアラート閾値は `docs/ops/monitoring.md`。
...
- [x] CI/CD（GitHub Actions）・IaCコア（Terraform）・メトリクス公開（Micrometer/Prometheus、工程10の一部）
- [ ] 監視アラート実配線 / E2E / IaC残リソース / 運用手順書（工程10の残り）
