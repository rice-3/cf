 ...
 */
class SandboxWebhookVerificationTest : FunSpec({
    ...
    fun sign(timestamp: String, rawBody: String = body) =
        SandboxPaymentGatewayAdapter.signForTesting(secret, timestamp, rawBody)
